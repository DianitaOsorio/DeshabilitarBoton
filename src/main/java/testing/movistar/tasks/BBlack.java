...
import static testing.movistar.userinterfaces.BBlack.*;


public class BBlack implements Task {
    @Override
    ...
    public static BBlack socialMedia() {
        return Instrumented.instanceOf(BBlack.class).withProperties();
    }
}