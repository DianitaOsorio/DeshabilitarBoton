...
import static testing.movistar.userinterfaces.BGold.*;


public class BGold implements Task {
    @Override
    ...
    public static BGold socialMedia() {
        return Instrumented.instanceOf(BGold.class).withProperties();
    }
}