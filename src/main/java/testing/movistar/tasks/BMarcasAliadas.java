...
import static testing.movistar.userinterfaces.BMarcasAliadas.*;

public class BMarcasAliadas implements Task {
    @Override
    ...
    public static BMarcasAliadas socialMedia() {
        return Instrumented.instanceOf(BMarcasAliadas.class).withProperties();
    }
}