...
import static testing.movistar.userinterfaces.BMejoraCategoria.*;

public class BMejoraCategoria implements Task {
    @Override
    ...
    public static BMejoraCategoria socialMedia() {
        return Instrumented.instanceOf(BMejoraCategoria.class).withProperties();
    }
}