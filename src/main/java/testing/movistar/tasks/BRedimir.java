...
import static testing.movistar.userinterfaces.BRedimir.*;

public class BRedimir implements Task {
    @Override
    ...
    public static BRedimir socialMedia() {
        return Instrumented.instanceOf(BRedimir.class).withProperties();
    }
