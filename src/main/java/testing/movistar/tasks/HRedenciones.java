...
import static testing.movistar.userinterfaces.HRedenciones.*;

public class HRedenciones implements Task {
    @Override
    ...
    public static HRedenciones socialMedia() {
        return Instrumented.instanceOf(HRedenciones.class).withProperties();
    }
}