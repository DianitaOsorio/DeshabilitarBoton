...
import static testing.movistar.userinterfaces.NoticiaServicios.*;

public class NoticiaServicios implements Task {
    @Override
    ...
    public static NoticiaServicios socialMedia() {
        return Instrumented.instanceOf(NoticiaServicios.class).withProperties();
    }
}