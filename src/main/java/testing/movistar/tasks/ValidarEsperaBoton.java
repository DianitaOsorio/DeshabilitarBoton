...
import static testing.movistar.userinterfaces.ValidarEsperaBoton.*;

public class ValidarEsperaBoton implements Task {
    @Override
    ...
    public static ValidarEsperaBoton socialMedia() {
        return Instrumented.instanceOf(ValidarEsperaBoton.class).withProperties();
    }
