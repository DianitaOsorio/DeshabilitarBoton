...
public class HRedenciones {
    ...
    public static final Target BTN_H_REDENCIONES = Target.the("click en boton historico redenciones")
            .locatedBy("//*[contains(@text,'Historial de redenciones')]");
