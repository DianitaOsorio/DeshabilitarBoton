...
public class ValidarEsperaBoton {
    ...
    public static final Target LBL_VALIDAR_TEXTOMODAL= Target.the("validar texto modal")
            .locatedBy("//hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.widget.TextView[3]");

    public static final Target BTN_ACEPTAR= Target.the("validar texto modal")
            .locatedBy("//android.widget.TextView[contains(@text,'ACEPTAR')]");
}
