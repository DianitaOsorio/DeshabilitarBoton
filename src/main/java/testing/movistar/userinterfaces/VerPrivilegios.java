...
public class VerPrivilegios {
    ...
    public static final Target LBL_VALIDAR_TEXTO = Target.the("click en boton ver mis privilegios")
            .locatedBy("//android.widget.TextView[contains(@text,'Tus privilegios2 de 7')]");
